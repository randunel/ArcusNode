...
NetConnection.prototype.init = function(arcus, id, socket, settings) {
  ...
  this._validCallback = function(callback){
 ...
 */
NetConnection.prototype.commandResult = function(message, result) {
  this.__p.arcus.commandResult(this, message, result);
};
 ...
 */
NetConnection.prototype.command = function(name, callback){
  this.commands.add(name, this._validCallback(callback));
  //Allow chaining
  return this;
};

//Synonyms for NetConnection#command
NetConnection.prototype.onCommand = NetConnection.prototype.command;
